      ...
      <div>
       ...
       p-1 text-center text-white shadow-sm"
        ...
        <div className="flex flex-1">
          <div className="inline-block w-16 flex-col items-center border-t border-r border-primary-200 bg-primary pt-4 text-center align-top">
            {userData?.Workspaces.map((ws) => (
              <Link key={ws.id} href={`/workspace/${ws.url}/channel/일반`}>
                <button className="mb-4 inline-block h-10 w-10 cursor-pointer rounded-xl border-4  border-primary bg-white text-lg font-bold text-black">
          ...
          <nav className="inline-flex w-64 flex-col bg-primary align-top text-[#bcabbc]">
            <div
